...
public class RealTimeGetComponent extends SearchComponent
{
  ...
  public int createSubRequests(ResponseBuilder rb) throws IOException {
    ...
    final String routes[] = params.getParams("route");
    final String route = (routes == null) ? null : routes[0];
    ...
    if (zkController != null && params.get(ShardParams.SHARDS) == null) {
      ...
      for (String id : reqIds.allIds) {
        Slice slice = coll.getRouter().getTargetSlice(id, null,route, params, coll);
